...
def q2():
    ...
    return float(np.round(ecdf(dataframe['normal'].mean() + dataframe['normal'].std())            - ecdf(dataframe['normal'].mean() - dataframe['normal'].std()), 3))
...
def q5():
    ...
    false_pulsar_first_quantile, false_pulsar_second_quantile, false_pulsar_third_quantile     = stars['false_pulsar_mean_profile_standardized'].quantile([0.25, 0.5, 0.75])
