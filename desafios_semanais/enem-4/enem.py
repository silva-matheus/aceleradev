...
ensemble_classifier = ensemble.RandomForestClassifier(n_estimators=500)
model = ensemble_classifier.fit(x, y)
print(ensemble_classifier.score(x, y))
...
# gb_classifier = ensemble.GradientBoostingClassifier(n_estimators=500)
# model = gb_classifier.fit(x, y)
# print(gb_classifier.score(x, y))
...
df['IN_TREINEIRO'] = predictions
df_answer = df[['NU_INSCRICAO', 'IN_TREINEIRO']]
